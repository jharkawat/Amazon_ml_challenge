...
parser.add_argument('--trained_model', default='/home/dsanyal/.pix2pix/off-by-one-bit-/finetune_multiclass/sample-distilbert-run2/finetuned_BERT_epoch_1.model', help="saved model name from huggingface")
...
parser.add_argument('--experiment_name', default='sample-distilbert-run2', help="model name from huggingface")
...
if (__name__ == "__main__"):
    ...
    labels_test = torch.tensor(df.BROWSE_NODE_ID.values)
